...
The subset and the standardize approach can improve the optimization time by a factor of 2 in this example compared to the random initialization approach.
