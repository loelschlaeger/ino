...
```{r, load ino, eval = FALSE}
install.packages("ino")
library("ino")
```

```{r, load ino for real, include = FALSE}
#library("ino")
devtools::load_all()
```
