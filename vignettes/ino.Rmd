...
1. defining initial values with one of the `initialize_*()` methods
2. calling `$optimize()`

```{r, example optimization, eval = FALSE}
Nop_mixture$
