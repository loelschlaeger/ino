...
We introduce the `{ino}` package (short for **initialization of numerical optimization**), designed to address the aforementioned questions. This package facilitates:
...
Accessing the optimization results is achievable through the `$results` field:

```{r, access results}
Nop_mixture$results |> head()
```
...
| Method                   | Purpose                                                                                                           |
|--------------------------|-------------------------------------------------------------------------------------------------------------------|
| `initialize_filter()` | Filters initial values based on positive or negative gradient or Hessian.   |
...
The `autoplot()` method offers a visual comparison of the optimization times:
