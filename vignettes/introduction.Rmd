...
The data set contains two variables: the eruption time and the waiting time to the next eruption (both given in minutes).
...
x <- fixed_initialization(x,
                          at = list(c(2, 4, log(1), log(1), qlogis(0.5)), 
