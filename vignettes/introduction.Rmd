...
```{r}
geyser_ino <- random_initialization(geyser_ino, sampler = function() stats::rnorm(npar(geyser_ino), mean = 2, sd = 0.5))
```
...
geyser_ino <- standardize_initialization(
  geyser_ino, initialization = random_initialization(runs = 5))
...
geyser_ino <- subset_initialization(
    geyser_ino, prop = 0.5, initialization = random_initialization(run = 5))
```
