...
```{r, define Nop}
Nop_probit <- Nop$new(f = f_ll_mnp, npar = 7, data = probit_data, neg = TRUE)$
...
Nop_probit$true_parameter <- theta
```
...
Nop_probit$optimize(initial = "random", runs = 100, label = "random")
```
...
Nop_probit$deviation(
  reference = Nop_probit$true_parameter, which_run = c("random", "subset"),
