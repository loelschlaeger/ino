...
The {ino} R package implements initialization strategies and analysis tools for numerical optimization of real-valued functions, with a specific focus on likelihood functions of statistical models.
